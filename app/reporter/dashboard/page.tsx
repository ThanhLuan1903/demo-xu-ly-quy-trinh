      ...
      <div className="p-4 md:p-8 bg-slate-50 min-h-screen">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-slate-900 mb-2">Báo cáo sự cố</h1>
              <p className="text-slate-600">Quản lý và theo dõi các báo cáo sự cố của bạn</p>
            </div>
            <Button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-blue-600 font-semibold text-sm mb-1">AI Chatbot</p>
                  <p className="text-slate-700 text-sm">Trò chuyện với AI để được hỗ trợ</p>
                </div>
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-green-600 font-semibold text-sm mb-1">Xem Quy trình</p>
                  <p className="text-slate-700 text-sm">Tìm hiểu các quy trình mua sắm</p>
                </div>
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-orange-600 font-semibold text-sm mb-1">Báo cáo của tôi</p>
                  <p className="text-slate-700 text-sm">Xem tất cả báo cáo của bạn</p>
                </div>
          ...
          {/* Recent Reports */}
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-6">Báo cáo gần đây của tôi</h2>
            {loading ? (
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-slate-600 mb-3">
                          Ngày báo cáo: {new Date(report.created_at).toLocaleDateString("vi-VN")}
                        </p>
